...
function brave_init_popup(popupID, popupData ){
   ...
   if(popupData.settings && popupData.settings.frequency && popupData.settings.frequency.repeat && brave_popup_adminUser === false ){  
      ...
      var popupViewDayCount = 0; var popupViewMonthCount = 0; var popupView12hCount = 0; var popupView6hCount = 0;
      if(popupViewStat){
      ...
      if(popupRepeatCountType === '12h' && (parseInt(popupView12hCount, 10) >= repeatCount)){
         return console.log('Already Viewed '+repeatCount+' Times in last 12hrs. Hiding..');  
      }
      if(popupRepeatCountType === '6h' && (parseInt(popupView6hCount, 10) >= repeatCount)){
         return console.log('Already Viewed '+repeatCount+' Times in last 6hrs. Hiding..');  
      }
      if(popupRepeatCountType === 'session' && (parseInt(popupOpenSessionCount, 10) >= repeatCount) ){
         return console.log('Already Viewed '+repeatCount+' Times for this Session. Hiding..');  
      }
