...
function brave_animate_popup(animationData, popupID, currentStep=0, animType='load'){
   ...
   var totalDuration = animationData[currentStep][animDevice].totalDuration;
   //console.log(animationData, currentElements);
   ...
   currentElements.forEach(function(element) {
      if(element.id && element.animation && element.animation[animType]){
         ...
         if(element.id === 'popup'){
            ...
            secondSelectorVals = {
               targets: `#brave_element-${element.id} .brave_popup__step__${animDevice} .brave_element__inner`,
               duration:duration,
               easing: easing,
               opacity: opacityVals,
            }
         ...
         //console.log(currentElements, secondSelectorVals);
