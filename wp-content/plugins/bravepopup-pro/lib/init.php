    ...
    class BravePopup_Initialize {
        ...
        public function add_dashboard_page() {
         $svg = '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="30px" viewBox="0 0 25 30" enable-background="new 0 0 25 30" xml:space="preserve">
            ...
            add_submenu_page( 'bravepop', 'All Campaigns', 'All Campaigns', 'edit_posts', 'bravepop', array( $this, 'bravepop_welcome_content' ) );
            add_submenu_page( 'bravepop', 'Submissions', 'Submissions', 'manage_options', 'bravepop-submissions', array( $this, 'bravepop_submissions_content' ));
